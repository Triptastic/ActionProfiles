...
A[3] = function(icon, isMulti)
	...
	VarPoolForCDs = A.VoidEruption:GetCooldown() == 0 
	...
	--actions.precombat+=/snapshot_stats
		...
		if A.UnholyNova:IsReady(player) and inCombat and UseCovenant and ((MultiUnits:GetByRange(15, 2) > 2 and Player:AreaTTD() > 10) or (Unit(unit):IsBoss() and Unit(unit):GetRange() <= 15)) then
